...
function prepareQuestions() {
  ...
  if (counter < (quiz.quizContent.length + quiz2.quizContent.length)) {
    // test op aantal vragen
...
function finishQuiz() {
  ...
  resultBox.innerHTML =
    "<h2>Jouw resultaat <br>goede antwoorden " +
    playerData.goodAnswers +
    "<br>foute antwoorden " +
    playerData.wrongAnswers +
    "</h2>";
  prizeBox.innerHTML = "<h2> Gefeliciteerd! U heeft een prijs gewonnen!";
}
